            ...
            <div class="max-w-7xl mx-auto p-6 lg:p-8" id="content">
                <nav class="flex items-center justify-between bg-gray-800 text-white p-4">
                    ...
                    <div>
                        ...
                        <span href="/contact" style="font-family: Fira Mono; color: #ffea5e" class="menu-link">Contact</span>
                    </div>
                ...
                <section>                    
                    <div class="container" style="margin-top: 120px">
                        <span class="hello"> <b>Get in Touch</b></span>
                    </div>
                    <div class="container" style="margin-top: 30px">
                        <p class="body">My inbox is always open. Whether you have a question or just want to say hello, I'll try my best to get back to you! Feel free to mail me about any relevant job updates.
                        </p>
                    </div>
                    <div class="flex justify-center">
                        <a href="mailto:intanshinta13@gmail.com" class="button button2">Mail me</a>
                    </div>
                </section>
