        ...
        <div style="background-color: #0F0F0F">
            ...
            <div class="max-w-7xl mx-auto p-6 lg:p-8" id="content">
                <nav class="flex items-center justify-between bg-gray-800 text-white p-4">
                    ...
                    <!-- Link-menu Navbar -->
                    <div>
                        <span href="/about" style="font-family: Fira Mono; color: #ffea5e" class="menu-link">About</span>
                ...
                <div class="mt-16" style="margin-left: 20px">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6 lg:gap-8 justify-start">
                        <div>
                            <p style="color: white; 
                            display: block;
                            font-family: poppins;
                            font-size: 12pt;
                            opacity: 0.5;" class="mt-4 text-gray-500 dark:text-gray-400 text-sm leading-relaxed">
                                I'm web developer based in Indonesia.
                                I am an enthusiastic and highly motivated in technology industry especially in web development. Besides that, I also like web design with Figma.
                            </p>
                            <br>
                            <p style="color: white; 
                            display: block;
                            ...
                            font-size: 12pt;
                            opacity: 0.5;">
                                I’m fresh graduate from STMI Polytechnic Jakarta in major information systems with GPA is <span style="color: #1aff00"> 3.81 </span> out of 4.00.
                            </p>
                            <br>
                            <p style="color: white; 
                            display: block;
                            ...
                            font-size: 12pt;
                            opacity: 0.5;">
                                During my studies, I served as Chief of Information and Communication Division <a href="https://himasis.org/" style="color: #5EFFE2"> HIMASIS Politeknik STMI Jakarta</a> (Feb 2021 - Jan 2022) and
                                Chief of Creative Division <span style="color: #5EFFE2"> IM3 Squadron</span>  (Nov 2021 - Jan 2022).
                            </p>
                            <span style="color: white; 
                            display: block;
                            font-family: poppins;
                            font-size: 14pt;
                            opacity: 0.8; margin-top:10px"> Skills and Tools:
                            </span>
                            <div class="p-6" style="font-size: 40px">
                        ...
                        <div class="container">
                            <div style="width:40%; display: inline-block;">
                                <img src="191.jpg" alt="Image 1">                            
                            </div>
                            <div style="width:50%; margin-left:20px; display: inline-block;">
                                <img src="192.jpg" alt="Image 2">                            
                            </div>
                        </div>
                    </div>
                </div>
