        ...
        <style>
            ...
            *,::after,
            ...
            .profile-img {
                ...
                margin-top: 80px; /* Memberikan jarak dari elemen di bawahnya */
            }
            ...
            <div class="max-w-7xl mx-auto p-6 lg:p-8" id="content">
                <nav class="flex items-center justify-between bg-gray-800 text-white p-4">
                    ...
                    <div class="flex items-center">
                        <span class="text-xl font-bold" style="font-family: Fira Mono; color: #5EFFE2">ISN</span>
                    </div>
                ...
                <section id="home">
                    <div class="container">
                        <img src="{{ asset('profile.png') }}"  class="profile-img" width="100"><br>
                    </div>
                    
                    <div class="container" style="margin-top: 20px">
                        <span class="hello"> <b>Hi! I am</b></span>
                    </div>
                    <div class="container">
                        <span class="hello"><b>Intan Shinta Nuriyah</b></span>
                    </div>
                    <div class="container">
                        <p class="body">I'm fresh graduate of information systems at <a href="https://siio.stmi.ac.id/" style="color: #5EFFE2"> STMI Polytechnic Jakarta</a>. I am an enthusiastic and highly motivated individual.
                            Looking for opportunities to develop my skills to work in the technology industry especially in software development.
                            I like to learn new things, work in collaboration and have good communication skills
                        </p>
                    </div>
                </section>
